...
<head>
    ...
    <title>Show Data Pelanggan</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 header">
                <a href="../list_pelanggan.php"> Data Pelanggan </a>
            </div>
        </div>
        <div class="row main">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <p class="input-group-text"><?= $row['jk'] ?></p>
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">Tempat Lahir</div>
                    </div>
                    <p class="input-group-text"><?= $row['tmp_lahir'] ?></p>
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">Tanggal Lahir</div>
                    </div>
                    <p class="input-group-text"><?= $row['tgl_lahir'] ?></p>
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">Email</div>
                    </div>
                    <p class="input-group-text"><?= $row['email'] ?></p>
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">Kartu</div>
                    </div>
                    <p class="input-group-text"><?= $row['kartu_id'] ?></p>
                </div>
            </div>
            <div class="row main">
                <div class="col-md-3">
