        ...
        <section class="col-lg-7 connectedSortable ui-sortable">
            ...
            <div class="card">
                ...
                <div class="card-footer clearfix">
                    <button type="button" class="btn btn-primary float-right" fdprocessedid="a468bp"><i
            ...
            <div class="card bg-gradient-primary">
                <div class="card-header border-0 ui-sortable-handle" style="cursor: move;">
                    ...
                    <div class="card-tools">
                        <button type="button" class="btn btn-primary btn-sm daterange" title="Date range"
                            fdprocessedid="9pd3ta">
                            <i class="far fa-calendar-alt"></i>
                        </button>
                        <button type="button" class="btn btn-primary btn-sm" data-card-widget="collapse"
                            title="Collapse" fdprocessedid="6vh9qk">
                ...
                <div class="card-body">
                    <div id="world-map"
                        ...
                        <svg width="360.552" height="250">
                            <g transform="scale(0.37596663190823776) translate(0, 35.97631409616366)">
                                <path
                ...
                <div class="card-footer bg-transparent">
                    <div class="row">
                        <div class="col-4 text-center">
                            <div id="sparkline-1"><canvas width="120" height="75"
                                    style="width: 80px; height: 50px;"></canvas></div>
                            <div class="text-white">Visitors</div>
                        </div>

                        <div class="col-4 text-center">
                            <div id="sparkline-2"><canvas width="120" height="75"
                                    style="width: 80px; height: 50px;"></canvas></div>
                            <div class="text-white">Online</div>
                        </div>

                        <div class="col-4 text-center">
                            <div id="sparkline-3"><canvas width="120" height="75"
                                    style="width: 80px; height: 50px;"></canvas></div>
